...
def data_over_time(df, col):
    ...
    #Check column names after reset index
...
def most_successful(df,sport):
    ...
    if sport != 'Overall':
        ...
        #Rename the index column (which is the athlete's name) to 'Athlete' and 'Name' counts to 'Medals'
        x.rename(columns={'index':'Name','Name':'Medals'},inplace=True)

        # Merge based on the 'Name' column with the original dataframe
